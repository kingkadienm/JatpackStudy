...
import com.wangzs.jatpackstudy.viewmodel.HasMoreState
import com.wangzs.jatpackstudy.viewmodel.LoadState
 ...
 * MVVM BaseActivity
 */
abstract class MVVMBaseActivity<V : ViewBinding, M : BaseViewModel> : AppCompatActivity() {
    ...
    protected open fun getViewModel(): M? {
        ...
        if (type != null && type is ParameterizedType) {
            ...
            return ViewModelProvider(this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(application))[tClass as Class<M>]
        }
        return null
    }
